...
@Value
public class GateModifiedEvent extends AbsEvent<GateAggregateID> {

    String gateName;
    GateType gateType;
    List<String> allowedPersonnel;

    public GateModifiedEvent(GateAggregateID aggregateId, String gateName, GateType gateType, List<String> allowedPersonnel) {
        super(aggregateId);
