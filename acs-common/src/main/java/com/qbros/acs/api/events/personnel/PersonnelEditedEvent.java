...
@Value
public class PersonnelEditedEvent extends AbsEvent<PersonnelAggregateID> {

    Name firstName;
    Name lastName;
    E_mail email;

    public PersonnelEditedEvent(PersonnelAggregateID aggregateId, Name firstName, Name lastName, E_mail email) {
        super(aggregateId);
