...
@Value
public class EditPersonnelCmd extends AbsCommand<PersonnelAggregateID> {

    Name firstName;
    Name lastName;
    E_mail email;

    public EditPersonnelCmd(PersonnelAggregateID aggregateId, Name firstName, Name lastName, E_mail email) {
        super(aggregateId);
