...
@Value
public class CreateGateCmd extends AbsCommand<GateAggregateID> {

    String gateName;
    GateType gateType;
    List<String> allowedPersonnel;

    public CreateGateCmd(GateAggregateID aggregateId, String gateName, GateType gateType, List<String> allowedPersonnel) {
        super(aggregateId);
