...
@Value
public class GateAuthorizationSuccessEvent extends AbsEvent<GateAggregateID> {

    PersonnelID personnelID;
    ActionResult result;

    public GateAuthorizationSuccessEvent(GateAggregateID aggregateId, PersonnelID personnelID, ActionResult result) {
        super(aggregateId);
